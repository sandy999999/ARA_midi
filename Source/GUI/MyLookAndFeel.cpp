...
{
    auto avenirLightFont = juce::Typeface::createSystemTypefaceFor (BinaryData::AvenirLight07_ttf, BinaryData::AvenirLight07_ttfSize);
    setDefaultSansSerifTypeface (avenirLightFont);
}
...
ParamTextBox* MyLookAndFeel::createSliderTextBox (juce::Slider& slider)
{
    auto* textBox = new ParamTextBox();
...
juce::Font MyLookAndFeel::getTextButtonFont (juce::TextButton&, int buttonHeight)
{
    ...
    juce::Font font (avenirLightFont);
